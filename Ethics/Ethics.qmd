...
If you are using LLMs to process personal data of subjects of your subjects, please consult experts from your university.

Especially for everything that concerns patient data.

Turning off, that the model is not training on your inputs does not mean it complies with the GDPR.

## Use case
Example of GDPR conform use of research data:
Microsoft and OpenAI offer Possiblity of Azure Server in Europe that complies with those rules.
