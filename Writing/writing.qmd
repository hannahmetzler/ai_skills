...
## Output with better prompt {.smaller style="font-size: 0.4em;"}
...
## Original discussion converted to bullet points{.smaller style="font-size: 0.4em;"}
...
## Writing: Further use cases for academics
