...
- **ChatGPT 4** (Open AI): Kontextverständnis (komplexe, mehrschichtige Dialoge), Lernfähigkeit, vielseitig
- **Claude** (Anthropic): längere Texte, besseres Gedächtnis (500 Seiten) (Context window)
  - Gratis,  mit Limit
  - Geht aus Österreich nicht: [VPN und virtuelle Telefonnummer](https://anakin.ai/de/blog/claude-ai-phone-number-verification/), oder via andere Apps verwenden: [Anakin.ai](www.anakin.ai)
- [**Bard/Gemini**](https://gemini.google.com/app) (Google): Suchfähigkeit und Datenbasis, Integration mit Google Diensten
...
- Erster Überblick über neues Themengebiet & Brainstorming
...
- Datenset hochladen + Fragestellung
...
Could you please write a system prompt from our interaction here, that I can use again next time I want to ask you about coding, when I want a succinct answer? Please write it in JSON. 
...
## Custom GPT Variante: Digital Twin
