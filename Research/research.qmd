...
- LLM with scientific references
    -   [Example testosterone & behaviour](https://www.perplexity.ai/search/what-are-the-2WzaWWlKRm.4ge6IDNvx3w)
- For brainstorming, exploring a new topic
- Tip: Search for best tools using the "social" option to search Reddit and void clutter & adds
...
## Exercise Option 1: Elicit/Perplexity(10 min)

* Choose a research question where you have some expertise, or a completly new research question
