...
include an example on specific instructions here. Use something where the LLM can create a list, then choose the best. Like E. Mollick here: https://www.oneusefulthing.org/p/getting-started-with-ai-good-enough, in the figure after "working with AI ia a dialogue, not an order."
...
## Remember the LLMs patience & abundance

- Ask for several options and select one you like.
- 15 sentences, 30 ideas
- Push for:  
