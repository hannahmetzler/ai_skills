...
**Treat AI just like an infinitely *patient new* coworker who *forgets* everything you tell them each new conversation.** <small>[(Ethan Mollick)](https://www.oneusefulthing.org/p/getting-started-with-ai-good-enough) </small>
...
-   Clear language, for example specific verbs (*explain, summarize, list, comment, format* \[1\]) <!-- ![](images/specific_task_instructions.png) -->
...
-   writing a paper part
-   discussion in five different styles
-   discussion in bullet points for content, then convert to text with chosen style
-   doing a review of your paper, get feedback
-   adding extra content, e.g. website about reviewer instructions
