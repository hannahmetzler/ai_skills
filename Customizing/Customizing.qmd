...
## Exercise: Create your CustomGPT (15 min) {.smaller}
...
[prompt examples](https://www.reddit.com/r/ChatGPTPromptGenius/comments/1bq212c/3_chatgpt_megaprompts_i_use_daily_to_save_tons_of/) for other ideas:

- Proofreader
- LinkedIn content creator
- Email drafter

#### Add addtinional files that are relevant for your GPT:

#### E.g. Websites with instructions of how to peform the task.
