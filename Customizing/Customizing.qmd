...
*Note: These are ideas, that I am currently testing.*
...
<br>
[prompt examples for other ideas:](https://www.reddit.com/r/ChatGPTPromptGenius/comments/1bq212c/3_chatgpt_megaprompts_i_use_daily_to_save_tons_of/)
...
Many of those Custum GPTs are connected to databases of scientific literature.

They search through their database to provide accurate information, which the Chatbot then includes in its answer. (Retrieval Augmented Generation)
...
There are many other options: explore custom GPTs topic 'Research & Analysis'
