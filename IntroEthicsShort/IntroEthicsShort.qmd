...
- If you are using LLMs to process personal data of subjects, please consult experts (data protection officers) from your university. Especially for patient data. 
