...
-   Long prompts with lots of details, explanations and context
...
-   ChatGPT 4 is much better than the free version
...
-   Download ChatGPT app, use microphone & headphones
-   Use it often and try it out!
-   Spelling doesn't matter at all
-   80% with ChatGPT, then check it yourself - first draft

## Hallucinations

-   LLMs invent data that doesn't exist
    -   Why? Statistical language prediction
-   Much less of a problem than at the beginning

------------------------------------------------------------------------

### Hallucinations - strategies for verification

-   4 eyes principle: Model does 80%, I do the rest
-   Follow-up questions: Check this again, is it correct? Can you give me some sources?
...
-   Just try it out: Use it every day and be creative!
